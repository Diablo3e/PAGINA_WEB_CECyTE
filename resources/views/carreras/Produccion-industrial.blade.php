...
@section('archivo-programa-estudios', asset('pdfs/programas-estudios/Producción industrial.pdf'))
...
@section('competencias-egreso')
    <ul>
        ...
        <li>Auxilia en la mejora de procesos productivos.</li>
...
@section('descripcion-escenarios')
    <p>La formación que ofrece la carrera de Técnico en producción industrial permite al egresado, a través de la articulación de saberes de diversos campos, realizar actividades dirigidas a la:</p>
    <ul>
        <li>La inserción del sector productivo</li>
        <li>Continuar con sus estudios del nivel superior profesional.</li>
    </ul>
@endsection