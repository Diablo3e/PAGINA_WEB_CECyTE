    ...
    <div class="row justify-content-center g-4 mb-4">
      <div class="col-12 col-md-4">
        <a href="#" class="d-block text-center p-3 cta-card">
          <img src="https://cecytepuebla.edu.mx/wp-content/uploads/elementor/thumbs/logo-pnt-pjckdpo5vb0iakjov9esqkwc3l3u58mj0gv9ks9t90.png" class="img-fluid" alt="Plataforma Nacional de Transparencia">
        </a>
      </div>
      <div class="col-12 col-md-4">
        <a href="#" class="d-block text-center p-3 cta-card">
          <img src="https://cecytepuebla.edu.mx/wp-content/uploads/elementor/thumbs/logo-obligaciones-pjckdkyyx4u2oiqimpdnw4314nr02r3vbtlu6egs44.png" class="img-fluid" alt="Obligaciones de Transparencia">
        </a>
      </div>
    </div>
