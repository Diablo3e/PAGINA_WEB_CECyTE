        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul class="navbar-nav mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="ofertaDropdown">
                        ...
                        <li><a class="dropdown-item" href="{{ route('Fuentes_Alternas') }}">Fuentes Alternas de Energía</a></li>
                        <li><a class="dropdown-item" href="{{ route('Mantenemiento_Automotriz') }}">Mantenimiento Automotriz</a></li>
            ...
            <div class="d-flex ms-3">
                <button class="btn btn-outline-light search-button" type="button"
                        data-bs-toggle="collapse" data-bs-target="#search-bar"
                        aria-expanded="false" aria-controls="search-bar" title="Buscar">
