...
<div id="admin-gestion" class="content active">
    ...
    <div class="program">
        ...
        <button onclick="showDetails('produccion-industrial')">Ver más</button>
    </div>
    <div class="program">
...
<div id="Tecnologia" class="content">
    ...
    <div class="program">
        <img src="{{ asset('imagenes/gestion-produccion-industrial.jpg') }}" alt="Mecatrónica" class="program-img">
        <h3>Mecatrónica</h3>
        <button onclick="showDetails('programacion')">Ver más</button>
    </div>
    <div class="program">
        <img src="{{ asset('imagenes/gestion-produccion-industrial.jpg') }}" alt="Técnico en Mecatrónica" class="program-img">
